...
export default function Bayonamalar() {
  ...
  function ClickBotton(e) {
    ...
    axios
      .post("http://localhost:8080/api/statement/add", {
        firstName: polisFirstNameBayonnoma.current.value,
        lastName: polisNameBayonnoma.current.value,
        familyName: polisFatherBayonnoma.current.value,
        phoneNumber: polisTelBayonnoma.current.value,
        dateOfBirth: DataBayonnoma.current.value,
        statement: TuzilganBayonnoma.current.value,
        fromPlace: OlibKelinganJoyBayonnoma.current.value,
        staffComment: HodimHulosasiBayonnoma.current.value,
        fingerByte: PolisfingerBayonnoma,
        imageByte: PolisFotosBayonnoma,
      })
